...
void test_vector_quicksort(void)
{
	...
	rc = zsl_vec_quicksort(&v, 0, 4);
	zassert_true(rc == 0, NULL);
	zassert_equal(v.data[0], w.data[0], NULL);
	zassert_equal(v.data[1], w.data[1], NULL);
	zassert_equal(v.data[2], w.data[2], NULL);
	zassert_equal(v.data[3], w.data[3], NULL);
	zassert_equal(v.data[4], w.data[4], NULL);
}
